...
file_path = r"C:\Users\ADMIN\Desktop\Semester 08\CO425 FYP II\reddit\Fakeddit\all_samples (also includes non multimodal)\all_validate.csv"
...
output_path = "cleaned_validate_with_labels.csv"  # Change filename for valid/test
