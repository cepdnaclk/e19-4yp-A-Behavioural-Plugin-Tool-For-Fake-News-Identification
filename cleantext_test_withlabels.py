...
file_path = r"C:\Users\ADMIN\Desktop\Semester 08\CO425 FYP II\reddit\Fakeddit\all_samples (also includes non multimodal)\all_test_public.csv"
...
output_path = "cleaned_test_with_labels.csv"  # Change filename for valid/test
